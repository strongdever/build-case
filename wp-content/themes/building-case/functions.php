...
function theme_add_files() {
    ...
    wp_enqueue_style('c-slick-theme', 'https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick-theme.css?ver=6.3.1', [], '1.0', 'all');
    wp_enqueue_style('c-slideshow', T_DIRE_URI.'/assets/css/slideshow.css', [], '1.0', 'all');
